...
public class EnviaEmail {
	...
	public void enviar() {
		try {
			...
			final String usuario = "jonathan407@gmail.com";
			final String senha = "85899669";
			...
			//destinatario
			mailMessage.setRecipients(Message.RecipientType.TO, InternetAddress.parse("reidosvazamentos@gmail.com"));		
